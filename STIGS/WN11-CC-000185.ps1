<#
.SYNOPSIS
    Configures the default AutoRun behavior to prevent AutoRun commands from executing.
    This reduces the risk of malicious code being introduced through removable media or other AutoRun-capable sources.
...
# WN11-CC-000185 - Prevent execution of AutoRun commands
# Run as Administrator
